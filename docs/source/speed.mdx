...
>>> print(f"safetensors is faster than pytorch by: {load_time_pt/load_time_st:.1f} X")
Loaded safetensors 0:00:00.004015
Loaded pytorch 0:00:00.307460
safetensors is faster than pytorch by: 76.6 X
```
...
safetensors is faster than pytorch by: 2.1 X
```
